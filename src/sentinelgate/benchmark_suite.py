"""Reproducible release evidence: latency, efficacy and resilience."""
...
def run(iterations: int = 2000) -> dict[str, object]:
    ...
    return {
        ...
        "efficacy": run_evaluation(corpus),
        "resilience": run_resilience(),
        "limitations": [
            "Local policy-path latency excludes network and connector latency.",
            "The bundled attack corpus is authored by the project and is not independent validation.",
